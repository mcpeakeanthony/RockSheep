...
((story.config = {
  ...
  (story.interactions = {
    ...
    //keyboard access for the click/pointerup-only story hotspots bound in story-main.js
    hotspotSelectors: [
      ".js-sheep1-container",
      ".js-sheep3-container",
      ".js-sheep-container",
    ...
    makeHotspotsAccessible: function () {
      ...
      $hotspots.on("keydown.storyRuntimeA11y", function (e) {
        ...
        e.preventDefault();
        //hotspots are bound via either click or pointerup depending on the page - trigger both
        $(this).trigger("click").trigger("pointerup");
      });
    },
  }),
  (story.effects = {
