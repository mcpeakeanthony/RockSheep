...
story.page2 = function () {
  ...
  sheep1Container.on("click.storyRuntime", function (e) {
    if (!$(this).hasClass("js-running")) {
      ...
      TweenMax.to(this, 1, {
        ...
        delay: 1.6,
        onComplete: function (element) {
          TweenMax.set($(".js-sheep1-container"), {
            xPercent: -150,
            yPercent: 0,
            scale: 1,
            zIndex: 26,
  ...
  sheep3Container.on("click.storyRuntime", function (e) {
    if (!$(this).hasClass("js-running")) {
      ...
      TweenMax.to($(".js-sheep3"), 0.5, {
        yPercent: "-=60",
        ease: Circ.easeNone,
        yoyo: true,
        repeat: 5,
        onRepeat: function (element) {
        ...
        onComplete: function (element) {
          TweenMax.set($(".js-sheep3-container"), {
            xPercent: 250,
            yPercent: 0,
            scale: 1,
            zIndex: 19,
  ...
  TweenMax.to(sheep2[0], duration / 4, {
    y: -50,
    ease: Sine.easeOut,
    repeat: -1,
    yoyo: true,
  });
  TweenMax.to(sheep2[0], duration / 2, {
    rotation: -15,
    ease: Sine.easeOut,
    repeat: -1,
    yoyo: true,
  });
  TweenMax.to(sheep2container[0], 3, {
    x: -1200,
    y: 50,
...
story.page3 = function () {
  ...
  function sleepySheep() {
    ...
    if (!sleepingSheep.length) {
      return;
    }

    var randomSheep =
      sleepingSheep[Math.floor(Math.random() * sleepingSheep.length)];
  ...
  sleepLoop = story.runtime.setInterval(sleepySheep, 3000);
  story.runtime.addCleanup(function () {
    if (sleepLoop) {
      story.runtime.clearInterval(sleepLoop);
      sleepLoop = null;
    }
  });
...
story.page4 = function () {
  ...
  TweenMax.to(element[0], duration / 4, {
    y: -100,
    ease: Sine.easeOut,
    repeat: -1,
    yoyo: true,
  });
  TweenMax.to(element[0], duration / 2, {
    rotation: 20,
    ease: Sine.easeOut,
    repeat: -1,
    yoyo: true,
  ...
  TweenMax.to(element2[0], duration / 4, {
    y: -75,
    ease: Sine.easeOut,
    repeat: -1,
    yoyo: true,
  });
  TweenMax.to(element2[0], duration / 2, {
    rotation: 30,
    ease: Sine.easeOut,
    repeat: -1,
    yoyo: true,
  });
  TweenMax.to(container2[0], 6, {
    x: -1000,
    y: 250,
    ease: Power0.easeNone,
    repeat: -1,
...
story.page6 = function () {
  ...
  TweenMax.to($(".js-sheep-container"), 0.5, {
    rotation: -15,
    ease: Linear.easeInOut,
    yoyo: true,
    repeat: -1,
  });
  TweenMax.to($(".js-sheep1"), 0.5, {
    yPercent: -15,
    ease: Power2.easeOut,
    yoyo: true,
    repeat: -1,
  });
  TweenMax.to($(".js-sheep2"), 0.6, {
    rotation: 5,
    yPercent: -5,
    ease: Power2.easeOut,
    yoyo: true,
  ...
  $(".js-amplifier-container").on("click.storyRuntime", function (e) {
    if (!$(this).hasClass("js-running")) {
      ...
      $(".js-musical-note").each(function () {
        TweenMax.to($(this), 0.25, { opacity: 0.8 });

        TweenMax.to($(this), story.effects.random_number(0.5, 0.85), {
...
story.page13 = function () {
  ...
  //ambient crowd sway
  TweenMax.to($(".sheep")[0], 0.8, {
    yPercent: "-=3",
    ease: Sine.easeInOut,
    repeat: -1,
    yoyo: true,
  });
  TweenMax.to($(".sheep")[0], 1.6, {
    rotation: 2,
    ease: Sine.easeInOut,
    repeat: -1,
    yoyo: true,
  ...
  //rocksheep performer bounce
  TweenMax.to($(".rocksheep")[0], 0.5, {
    yPercent: "-=6",
    ease: Sine.easeOut,
    repeat: -1,
    yoyo: true,
  ...
  //roses launched together toward the stage, fading out, then the burst repeats
  var roseBurstDuration = 1.3;
  var roseBurstRepeatDelay = 5;

  TweenMax.to($(".rose1")[0], roseBurstDuration, {
    xPercent: 90,
    yPercent: -60,
    rotation: -30,
    autoAlpha: 0,
    ease: Power2.easeOut,
    repeat: -1,
    repeatDelay: roseBurstRepeatDelay,
  });
  TweenMax.to($(".rose2")[0], roseBurstDuration, {
    xPercent: 60,
    yPercent: -90,
    rotation: 20,
    autoAlpha: 0,
  ...
  TweenMax.to($(".rose3")[0], roseBurstDuration, {
    xPercent: 110,
    yPercent: -30,
    rotation: -15,
    autoAlpha: 0,
  ...
  TweenMax.to($(".rose4")[0], roseBurstDuration, {
    xPercent: 75,
    yPercent: -70,
    rotation: 35,
    autoAlpha: 0,
...
story.page23 = function () {
  ...
  TweenMax.to($(".js-rocksheep"), 2, {
    y: -8,
    ease: Power0.easeNone,
    repeat: -1,
    yoyo: true,
  });
  TweenMax.to($(".js-arm-left"), 2, {
    rotation: 8,
    ease: Power0.easeNone,
    repeat: -1,
    yoyo: true,
  });
  TweenMax.to($(".js-arm-right"), 2, {
    rotation: 8,
    ease: Power0.easeNone,
    repeat: -1,
    yoyo: true,
  ...
  $(".js-rocksheep").on("click.storyRuntime", function (e) {
    ...
    var duration = 1;
    TweenMax.to($(".js-rocksheep"), duration / 4, {
      y: -50,
      ease: Power2.easeOut,
    });
    TweenMax.to($(".js-rocksheep"), duration / 2, {
      y: 0,
      ease: Bounce.easeOut,
      delay: duration / 4,
    });
    ...
    TweenMax.to($(".js-rocksheep-head"), 0.5, {
      rotation: 8,
      ease: Power0.easeNone,
      repeat: 1,
      yoyo: true,
    });
    TweenMax.to($(".js-rocksheep-ear"), 0.4, {
      rotation: -20,
      ease: Power0.easeNone,
      repeat: 1,
      yoyo: true,
...
story.page24 = function () {
  ...
  var swimSheepTl = new TimelineMax();

  var $swimSheepContainer = $(".swim-sheep-container"),
    $swimSheepContainer2 = $(".swim-sheep-container2");

  swimSheepTl.to($swimSheepContainer, 10, {
    x: 65,
    y: 10,
    ease: Power0.easeOut,
    repeat: -1,
  ...
  TweenMax.to($swimSheepContainer2, 1, {
    y: 5,
    ease: Power0.easeOut,
    repeat: -1,
    yoyo: true,
  ...
  $(".swim-sheep-container").on("click.storyRuntime", function (e) {
    if (!$(this).hasClass("js-running")) {
      ...
      swimSheepTl.pause();
      TweenMax.to($(".swim-sheep-container"), 0.5, {
        y: -25,
        rotation: -15,
        ease: Power0.easeOut,
        repeat: 1,
  ...
  var $crocSheepHeadContainer = $(".croc-sheep-head-container"),
  ...
  var crocSheepTl = new TimelineMax();

  crocSheepTl.add(
    TweenMax.to($crocSheepHeadContainer, 1.5, {
      rotation: 10,
      ease: Power2.easeOut,
      repeat: -1,
      yoyo: true,
  ...
  TweenMax.to($crocSheepRightArm, 0.4, {
    rotation: "-=50",
    ease: Power2.easeInOut,
    repeat: -1,
    yoyo: true,
  ...
  TweenMax.to($crocSheepleftArm, 0.3, {
    rotation: "-=50",
    ease: Power2.easeInOut,
    repeat: -1,
    yoyo: true,
  ...
  TweenMax.to($crocSheepRightLeg, 0.2, {
    rotation: "-=50",
    ease: Power2.easeInOut,
    repeat: -1,
    yoyo: true,
  ...
  TweenMax.to($crocSheepLeftLeg, 0.4, {
    rotation: "-=50",
    ease: Power2.easeInOut,
    repeat: -1,
    yoyo: true,
  ...
  crocSheepTl.to($(".croc-sheep-arm-left"), 1.5, {
    rotation: 10,
    ease: Power2.easeOut,
    repeat: -1,
    yoyo: true,
  ...
  $(".croc-sheep-container").on("click.storyRuntime", function (e) {
    if (!$(this).hasClass("js-running")) {
      ...
      TweenMax.to($(".croc-sheep-eye-right"), 0.2, {
        xPercent: story.effects.random_number(-500, -30),
        yPercent: story.effects.random_number(-500, -5),
      ...
      TweenMax.to($(".croc-sheep-eye-left"), 0.3, {
        xPercent: story.effects.random_number(500, 30),
        yPercent: story.effects.random_number(-500, -5),
        ease: Elastic.easeOut.config(1, 0.3),
        repeat: 3,
      ...
      TweenMax.to($(".croc-sheep-hat-mouth"), 0.3, {
        rotation: -15,
        ease: Elastic.easeOut.config(1, 0.3),
        repeat: 3,
        repeatDelay: 0.3,
  ...
  TweenMax.to($(".squirrel-sheep-tail"), 0.5, {
    rotation: 5,
    ease: Power0.easeNone,
    repeat: -1,
    yoyo: true,
  ...
  $(".squirrel-sheep-container").on("click.storyRuntime", function (e) {
    if (!$(this).hasClass("js-running")) {
      ...
      TweenMax.to($(".squirrel-sheep-acorn"), 0.5, {
        yPercent: -60,
        ease: Power2.easeOut,
      });
      TweenMax.to($(".squirrel-sheep-acorn"), 0.1, {
        yPercent: -55,
        ease: Power2.easeOut,
        delay: 0.5,
        repeat: 5,
  ...
  TweenMax.to($(".hotdog-sheep-container"), 0.3, {
    yPercent: -10,
    ease: Circ.easeNone,
    yoyo: true,
    repeat: -1,
  });
  TweenMax.to($(".hotdog-sheep-container"), 0.7, {
    rotation: -4,
    ease: Linear.easeNone,
    yoyo: true,
    repeat: -1,
  ...
  TweenMax.to($(".ballerina-sheep-container"), 0.4, {
    yPercent: -10,
    ease: Circ.easeNone,
    yoyo: true,
    repeat: -1,
  });
  TweenMax.to($(".ballerina-sheep-container"), 0.8, {
    rotation: -10,
    ease: Linear.easeNone,
    yoyo: true,
    repeat: -1,
